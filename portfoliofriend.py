...
with st.beta_container():
    ...
    p= st.radio("Select time perdiod for all Assets",('1y','5y','Max'))
    st.write("#")


    #dictionaries for portfoolio metrics and correlation matrix
    d = persistdata()    
    corr=persistdata_2()
    ...
    button = st.button("Click here to add asset to Portfoloio")
    if button:
        if stock and units:  
